...
<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search" <?php if ($waiAriaRoles) echo 'role="form"'; ?>>
	<div class="finder<?php echo $suffix; ?>" <?php if ($waiAriaRoles) echo 'role="search"'; ?>>
		<?php
